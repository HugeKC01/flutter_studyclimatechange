...
class HoverableImageNEW extends StatefulWidget {
  final String imagePath; // เส้นทางของรูปภาพ

  const HoverableImageNEW({super.key, required this.imagePath});

  @override
  HoverableImageNEWState createState() => HoverableImageNEWState();
}

class HoverableImageNEWState extends State<HoverableImageNEW> {
        ...
        child: AnimatedContainer(
          ...
          child: ClipRRect(
            ...
            child: Image.asset(
              ...
              width: MediaQuery.of(context).size.width * (_isHovered ? 0.5 : 0.5), //Change the width image size when hover : normal
