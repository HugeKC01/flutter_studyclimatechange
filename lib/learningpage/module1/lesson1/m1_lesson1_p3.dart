...
class m1_lesson1_p3 extends StatelessWidget {
  const m1_lesson1_p3({super.key});
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text(
                    'ในแต่ละปี โลกมีอุณหภูมิสูงขึ้นประมาณ 0.6 องศา',
                ...
                Padding(
                  ...
                  child: Text(
                    'หากเป็นแบบนี้ต่อไป โลกก็จะร้อนจนเราใช้ชีวิตไม่ได้',
                    style: TextStyle(fontSize: style.fontSizeBody),
                  ),
                ),
                Padding(
                ...
                Padding(
                  padding: EdgeInsets.only(top: 36.0),
                  child: Text(
                    'พื้นดินจะแห้งแล้งและทำให้การเพาะปลูกย่ำแย่',
                    style: TextStyle(fontSize: style.fontSizeBody),
                  ),
                ),
                Padding(
