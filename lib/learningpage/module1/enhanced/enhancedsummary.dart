...
class EnhancedM1ResultScreen extends StatelessWidget {
  final int score;
  final int totalQuestions;
  final List<Map<String, Object>> questions;
  final int elapsedSeconds;

  const EnhancedM1ResultScreen({
    super.key,
    required this.score,
            ...
            child: Container(
              ...
              children: [
                ...
                onPressed: () {
                  Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const EnhancedM1Introduction()),
                  );
                },
                ...
                onPressed: () {
                  Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Module1Sum()),
                  );
                },
