...
class PracticeM3Introduction extends StatelessWidget {
  const PracticeM3Introduction({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    'โดยการตอบคำถามที่เกี่ยวข้องกับเนื้อหาที่เรียนใน Module 3',
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const PracticeM3Screen(),
                        ),
                      );
                    },
