...
import 'm3_subject2_p5.dart';
import 'm3_subject2_p7.dart';
...
class ClimateChangeApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Module3Subject2Page6(),
    );
  }
}

class Module3Subject2Page6 extends StatelessWidget {
  const Module3Subject2Page6({super.key});
                        ...
                        child: FloatingActionButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const Module3Subject2Page5()),
                            );
                          },
                          backgroundColor:
                        ...
                        child: FloatingActionButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const Module3Subject2Page7()),
                            );
                          },
                          backgroundColor:
                              const Color.fromARGB(255, 255, 255, 255),
